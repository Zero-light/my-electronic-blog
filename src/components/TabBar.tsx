...
import { Home, BookOpen, Building2, Zap, ShoppingBag } from 'lucide-react';

export type TabId = 'home' | 'learn' | 'house' | 'challenge' | 'backpack';
...
const TABS: { id: TabId; label: string; Icon: React.FC<{ size?: number }> }[] = [
  ...
  { id: 'house', label: '家园', Icon: (p) => <Building2 {...p} /> },
